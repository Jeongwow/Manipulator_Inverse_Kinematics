...
void OpenManipulatorTeleop::setGoal(const std_msgs::Float32MultiArray::ConstPtr &pos_array)
{
    ...
    printf("joint1 : %.4f , joint2 : %.4f , joint3 : %.4f , joint3 : %.4f\n",pos_array->data[0],pos_array->data[1],pos_array->data[2],pos_array->data[3]);
    joint_name.push_back("joint1");
    joint_angle.push_back(pos_array->data[0]);
    joint_name.push_back("joint2");
    joint_angle.push_back(pos_array->data[1]);
    joint_name.push_back("joint3");
    joint_angle.push_back(pos_array->data[2]);
    joint_name.push_back("joint4");
    joint_angle.push_back(pos_array->data[3]);
