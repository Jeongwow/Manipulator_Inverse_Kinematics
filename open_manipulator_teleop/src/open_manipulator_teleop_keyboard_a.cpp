...
void OpenManipulatorTeleop::initSubscriber()
{
  ...
  // 추가됨.
  // callback 함수 만들어야함.
  ik_pos_jwK_sub = node_handle_.subscribe("ik_position", 10, &OpenManipulatorTeleop::setGoal, this);
...
void OpenManipulatorTeleop::setGoal(const std_msgs::Float64MultiArray::ConstPtr &pos_array)
{
